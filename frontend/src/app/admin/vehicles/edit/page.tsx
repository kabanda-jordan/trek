...
function EditVehicleForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSaving(true);
    try {
      await api.put(`/admin/vehicles/${id}`, {
        ...form,
  ...
  if (!id) return <div className="p-8 text-center text-slate-500">No vehicle ID provided</div>;
          ...
          <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <input type="text" value={form.model} onChange={(e) => set("model", e.target.value)} className="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500" />
              </div>
              <div>
...
export default function AdminVehiclesEditPage() {
  return (
